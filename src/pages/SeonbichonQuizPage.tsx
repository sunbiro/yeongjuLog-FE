...
const SEONBICHON_LOCATION_CODE = "SOSU_VILLAGE";
...
export default function SeonbichonQuizPage() {
  ...
  useEffect(() => {
    ...
    api
      .get<MissionResponse>(`/v1/missions/location/${SEONBICHON_LOCATION_CODE}?userId=${user.id}`)
      .then((res) => {
        ...
        <div className="absolute left-1/2 top-[200px] w-[430px] -translate-x-1/2">
          ...
          <form onSubmit={handleSubmit} className="absolute left-[70px] top-[172px] flex w-[290px] flex-col">
            <p className="ml-[5px] mt-[8px] h-[29px] text-[14px] font-black leading-[19px] text-[#f7e8c7]">
              선비촌에서 선비들이 학문을 닦고 손님을 맞이하던 공간의 이름은 무엇인가?
            </p>
            <input
              value={answer}
