...
import fireImg from "@/assets/images/foodchar.png";
...
const initialMessage =
  "아이고, 어서 오이소. 영주까지 오셨으면 맛난 거 한 그릇은 묵고 가야지예. 땡기는 음식이나 지금 위치를 말해주면 주모가 딱 맞는 맛집을 골라드릴게예.";
      ...
      <div className="relative flex h-full w-full flex-col overflow-hidden bg-[#24150d] font-inter">
        ...
        <main className="relative min-h-0 flex-1 overflow-hidden">
          ...
          <img
            src={fireImg}
            alt="도깨비불"
            className="pointer-events-none absolute -left-[80px] bottom-[70px] z-10 w-[226px] object-contain drop-shadow-[0_0_13px_rgba(43,185,255,0.9)]"
            draggable={false}
          />

          <div className="relative z-20 h-full overflow-y-auto overscroll-contain pb-5 pl-16 pr-4 pt-6">
            <div className="flex min-h-full flex-col gap-5 py-3">
              <div className="mt-auto" />
              <button
                type="button"
                onClick={() => navigate("/food")}
                className="mx-auto w-[calc(100%-30px)] max-w-[340px] rounded-[6px] border-[4px] border-[#5c3217] bg-[#d9a44a] px-4 py-3 text-center text-[13px] font-black leading-none text-[#321909] shadow-[0_5px_0_rgba(45,22,8,0.5)] active:translate-y-[2px] active:shadow-[0_3px_0_rgba(45,22,8,0.5)]"
              >
                영주 맛집 지도 보기
              </button>
              {messages.map((msg) => (
